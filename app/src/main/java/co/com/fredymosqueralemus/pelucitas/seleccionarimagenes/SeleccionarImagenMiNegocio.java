package co.com.fredymosqueralemus.pelucitas.seleccionarimagenes;
...
public class SeleccionarImagenMiNegocio {

    private Context context;
    private Activity activity;
    private String userChoose;
    public SeleccionarImagenMiNegocio(Context context, Activity activity){
    ...
    public void seleccionarImagenMiNegocio() {
